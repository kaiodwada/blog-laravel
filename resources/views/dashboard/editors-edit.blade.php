...
@section('content-dashboard')
    ...
    <div class="container flex items-center ml-80 justify-start mt-3">
        <a href="{{ route('editors-index') }}" type="button"
                        class="py-2.5 px-5  flex font-medium  focus:outline-none  rounded-lg border  hover:text-gray-100 focus:z-10 focus:ring-4  focus:ring-gray-700 bg-gray-800 text-gray-400 border-gray-600  hover:bg-gray-700">
